...
var factory = function factory(Overlay, IconButton) {
    var BottomSheet = function (_Component) {
        ...
        function BottomSheet() {
            ...
            return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BottomSheet.__proto__ || Object.getPrototypeOf(BottomSheet)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        _createClass(BottomSheet, [{
            ...
            value: function renderContent() {
                ...
                var _className = (0, _classnames3.default)(theme.bottomsheet, _defineProperty({}, theme.active, active), className);
                return _react2.default.createElement(
                    'div',
                    { 'data-react-toolbox': 'bottomsheet', className: _className, style: { bottom: bottom },
    ...
    BottomSheet.propTypes = {
        ...
        theme: _propTypes2.default.shape({
            ...
            bottomsheet: _propTypes2.default.string,
            bottomsheet__item: _propTypes2.default.string,
