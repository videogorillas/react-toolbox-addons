...
var RTNavigationChips = function (_Component) {
    ...
    function RTNavigationChips() {
        ...
        return _possibleConstructorReturn(this, (RTNavigationChips.__proto__ || Object.getPrototypeOf(RTNavigationChips)).apply(this, arguments));
    }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                headers.map(function (header, index) {
                    return _react2.default.createElement(
                        _grid.Col,
                        { key: index, shrink: headers.length === index + 1 },
